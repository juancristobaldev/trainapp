...
const SingUp = () => {
  ...
  const handleSubmit = async (e, stage) => {
    ...
    const { first_name, last_name, user, email, pass, passConfirm } =
        dataFusion,
      objectErrors = {};
    ...
    if (stage === "first") {
      ...
      if (pass !== passConfirm || !pass)
        objectErrors.passConfirm = "Las contraseñas deben coincidir.";
    }
        ...
        {typeForm === "about-u" ? (
          <>
            <Form
              className={`form-signup ${
                typeForm === "about-u" ? "about-u" : "auth"
              }`}
              onSubmit={
                typeForm === "about-u"
                  ? (e) => handleSubmit(e, "first")
                  : (e) => handleSubmit(e, "two")
              }
            ...
            >
              ...
              <FormControl
                ...
                label="Nombre:"
                onChange={(e) =>
                  handleChange(e, dataFormRegister, setDataFormRegister)
                }
              />
              <FormControl
          ...
          >
            ...
            <FormControl
              ...
              name="email"
              onChange={(e) =>
                handleChange(e, dataFormRegisterTwo, setDataFormRegisterTwo)
              }
            />
            <FormControl
              error={[errors.pass]}
