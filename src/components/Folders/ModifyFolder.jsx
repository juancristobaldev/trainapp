...
const ModifyFolder = ({token,closeFunction,folder}) => {
    ...
    useEffect(() => {
        if(folder){
            updateState({...state, dataFormCreate:{...dataFormCreate, content:JSON.parse(folder.content)}})
        }
    },[folder])
                ...
                {!modal && 
                    ...
                    childrenBottom={
                        <Container className={'buttons'}>
                            ...
                            <Button className={'create'} onClick={e => handleSubmit(e)} textButton={'Guardar cambios'}/>
                        </Container>
                    }
                    />
                }
