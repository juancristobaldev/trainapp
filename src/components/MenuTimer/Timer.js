  ...
  return (
    <Container className="timer">
      ...
      <Container className="timer-buttons">
        {timerState === true && (
          <button className="button-delete" onClick={() => sustractionTimer()}>
            -10seg
          </button>
        )}
        <button className="button-alter" onClick={() => startOrRestartTimer()}>
          {timerState ? <VscDebugRestart /> : <FaPlay />}
        </button>
        {timerState === true && (
          <button className="button-add" onClick={() => additionTimer()}>
            +10seg
          </button>
        )}
      </Container>
